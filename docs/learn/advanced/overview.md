...
- [**3ID Connect:**](../../docs/advanced/standards/accounts/cip79-3id-did.md#3id-connect) A authentication SDK for browser-based applications that allows your users to transact with Ceramic using their blockchain wallet.
