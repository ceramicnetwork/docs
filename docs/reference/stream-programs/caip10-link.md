...
The `stream-caip10-link` module export a `Caip10Link` class used to link and unlink a DID to a CAIP-10 address using the [CIP-9 "CAIP-10 Link" program](../../docs/advanced/standards/stream-programs/cip9-caip10-link.md).
